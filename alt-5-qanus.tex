...
seguimos la sugerencia sobre el uso responsable de otras wikipedias y utilizamos las siguientes snapshots encontrados en Wikidumps\footnote{link a wikidumps}.


\begin{center}
\begin{tabular}{ | l | l | l | l |}
    \hline
    Idioma & Fecha & Tamaño & Cantidad de archivos\\ \hline
    Español \footnote{\url{http://dump-español-1}} & 7 de julio de 2006 & 558M & archivos \\ \hline
    Portugués \footnote{\url{http://dump-español-1}} & fecha & peso & archivos \\ \hline
\end{tabular}  
\end{center}


% Durante el desarrollo y las pruebas utilizamos otras imagenes de wikipedia:
