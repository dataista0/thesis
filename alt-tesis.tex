...
\def\titulo{Question answering open y closed domain}
\def\runtitulo{Question answering open y closed domain}
\def\runtitle{Question answering open y closed domain}
...
\input{alt-1-introduccion.tex}
\input{alt-2-marco-teorico.tex}
\input{alt-3-estado-de-arte.tex}
\input{alt-4-mitic.tex}
\input{alt-5-qanus.tex}
\input{alt-6-conclusion.tex}

% \appendix
\nocite{*}

\begin{appendices}
  \input{alt-a-herramientas.tex}
  \input{alt-b-conclusion.tex}
\end{appendices}
