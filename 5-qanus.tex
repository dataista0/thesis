...
2007, el LymbaPA07 obtuvo un grado de precisión del 0.706 y el décimo (Quanta) obtuvo 0.206, mientras que QA-sys logra el 0.119 disponiendo de una implementación sumamente simple. La métrica de precisión, en esta competencia, consistió en la evaluación por parte de jueces humanos de una respuesta exacta única \cite{TREC07}.
