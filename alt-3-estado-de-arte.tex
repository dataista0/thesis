...
En este capítulo se busca pasar revista de diferentes investigaciones sobre question answering para poder ilustrarnos acerca del dominio de problemas y su estado de arte, las distintas formas de encararlos que existen. 
...
\section{Competencias y métricas de evaluación}
...
\subsection{Algunos ejemplos académicos}
\begin{itemize}
...
\subsection{No incorporado a QANUS}
...
\subsubsection{Otros sistemas de QA: OpenEphyra, Aranea y Just.Ask}
...
\chapter{Herramientas y enfoque}
